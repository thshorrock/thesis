...
follows that the sound profile of the emitting signal is expected %- from the pulse-echo definition -
...
The returned pulse would be transformed from the sinusoid in \figref{nonLinearOriginal} to the saw tooth in \figref{nonLinearSawTooth}.
...
Inserting this into equation \eqnref{relMass:stepOne} gives
\eqa{
  \label{eqn:relMass}
...
Continuing,
we note from Newton's second law and equation~\eqnref{relMass} that the rate of work
