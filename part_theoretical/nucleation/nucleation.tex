...
In \secref{nuc:evacuate} the critical radius was used to give a lower bound on the size of a generated/evacuated bubble.
It was seen that bubbles in the tens of nanometres could come stable when placed under tension by an acoustic wave.
However, the lifetime of the bubble after the rarefactional cycle has passed was not given,
and that is the goal of this section.
