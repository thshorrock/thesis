...
whence the Grand Potential equates to the Free Energy, $G$, because
\begin{align}
...
\begin{figure}
 \centering
  ...
  \subfloat[The parameter $\epsilon$ for  water]{\input{part_theoretical/nucleation/figs/chNucParamsEWater.tex}}\\
  \subfloat[The parameter $d$ for \pfp]{\input{part_theoretical/nucleation/figs/chNucParamsDPfp.tex}}
  \subfloat[The parameter $\epsilon$ for \pfp]{\input{part_theoretical/nucleation/figs/chNucParamsEPfp.tex}}\\
