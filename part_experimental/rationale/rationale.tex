...
\item[A bubble generated from a perflurocarbon emulsion:]\hfill \\
  ...
  The pressures that have hitherto been used to generate the bubbles are \unit{3}\mega\pascal\ for a \unit{0.5}\mega\hertz\ wave \cite{Scad2009}, far in excess of those used in diagnostic applications,
...
\section{Parameters under experimental control}
 ...
 at the focus.
 In addition, if a 2 dimensional  image is formed with the Cortex scanner,
...
We choose the frequencies of the two waves by virtue of the chosen transducers.
...
and a \unit{20}\mega\hertz\ (Panametrics, focal length: \unit{20}\milli\metre)  transducer was used for imaging.
...
\begin{figure}[h]
     ...
     \caption{Water sample driven at 0.4\mega\pascal}
