...
\nlist{
  ...
  \item A way of rapidly turning switching the imaging transducer from pulse-receive into receive-only mode (the imaging mode)
}
...
and a ...\todo{get preamplifer details} preamplifer.
...
The setup is illustrated in \figref{exp:setup:electronic:final}.
...
from the program that called the library, \coderef{experiment}.
%according to the 
