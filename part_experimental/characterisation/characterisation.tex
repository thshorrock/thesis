...
What is learnt from a given experiment is then characterised with how the probability distributions
...
\begin{align}
   P\lr{\vw|\vx,\H} =  \frac{P\lr{\vx|\vw,\H} P\lr{\vw|\H}}{P\lr{\vx|\H}}.
...
The right-hand-side of \eqnref{ModelCmp} therefore directly and quantitatively  embodies Occan's razor,
...
\begin{figure}[ht]%
 ...
 \quad
  ...
  \caption{
    ...
    The second pulse \protect\subref{fig:exp:control:av:pressure:108:second} is received \unit{100}\micro\second\ after the first \protect\subref{fig:exp:control:av:pressure:108:first}.
...
bear a strong resemblance to the simulated bubble pulsations of \chapref{mechanisms}.
...
\begin{figure}[t]%
 ...
 %    \label{fig:av:108:100_ex:second}
 %    \input{figs/water_cav_results/voltage_0.108/gap_between_pulses_100/imaging_1st_av_with_sd/voltage_0_108_gap_between_pulses_100_imaging_1st_av_with_sd_means1_large2.tex}}\\
  \subfloat[1st pulse - \unit{150}\micro\second\ (receive only)]{
    \label{fig:1st:av:time:150:comp:control:c1st}
    \input{figs/water_cav_results/voltage_0.108/gap_between_pulses_150/no_imaging_av_with_sd/voltage_0_108_gap_between_pulses_150_no_imaging_av_with_sd_means1_large2.tex}}
 \quad\hspace{3mm}
  \subfloat[1st pulse - \unit{150}\micro\second\ (pulse-echo)]{
    \label{fig:1st:av:time:150:comp:control:i1st}
    \input{figs/water_cav_results/voltage_0.108/gap_between_pulses_150/imaging_1st_av_with_sd/voltage_0_108_gap_between_pulses_150_imaging_1st_av_with_sd_means1_large2.tex}}\\
  \subfloat[1st pulse - \unit{250}\micro\second\ (receive only)]{
    \label{fig:1st:av:time:250:comp:control:c1st}
    \input{figs/water_cav_results/voltage_0.108/gap_between_pulses_250/no_imaging_av_with_sd/voltage_0_108_gap_between_pulses_250_no_imaging_av_with_sd_means1_large2.tex}}
 \quad\hspace{3mm}
  \subfloat[1st pulse - \unit{250}\micro\second\ (pulse-echo)]{
...
\begin{figure}[t]%
 ...
 %    \input{figs/water_cav_results/voltage_0.108/gap_between_pulses_100/imaging_2nd_av_with_sd/voltage_0_108_gap_between_pulses_100_imaging_2nd_av_with_sd_means1_large2.tex}}\\
  \subfloat[2nd pulse - \unit{150}\micro\second\ (receive only)]{
    \label{fig:2nd:av:time:150:comp:control:c2nd}
    \input{figs/water_cav_results/voltage_0.108/gap_between_pulses_150/no_imaging_av_with_sd/voltage_0_108_gap_between_pulses_150_no_imaging_av_with_sd_means1_large2.tex}}
 \quad\hspace{3mm}
  \subfloat[2nd pulse - \unit{150}\micro\second\ (pulse-echo)]{
  ...
  \subfloat[2nd pulse - \unit{250}\micro\second\ (receive only)]{
    \label{fig:2nd:av:time:250:comp:control:c2nd}
    \input{figs/water_cav_results/voltage_0.108/gap_between_pulses_250/no_imaging_av_with_sd/voltage_0_108_gap_between_pulses_250_no_imaging_av_with_sd_means1_large2.tex}}
 \quad\hspace{3mm}
  \subfloat[2nd pulse - \unit{250}\micro\second\ (pulse-echo)]{
...
\begin{figure}[t]%
 ...
 \quad
  ...
  subtracted from the first pulse when the imaging  wave  is in receive only mode - \unit{150}\micro\second]{
    \label{fig:exp:2nd:av:time:150:comp:control:cross:full}
...
\quad
  ...
  subtracted from the second pulse when the imaging wave is in receive only mode - \unit{250}\micro\second]{
    \label{fig:exp:2nd:av:time:150:comp:control:cross:full}
    \input{figs/water_cav_results/voltage_0.108/gap_between_pulses_250/imaging_2nd_av_with_sd/voltage_0_108_gap_between_pulses_250_imaging_2nd_av_with_sd_meansSub3_large_cross_full.tex}}
\caption{
...
re-plotted adjacent to each other in \figref{exp:av:time:comp:control:cross:full}.
...
%     \input{figs/water_cav_results/voltage_0.108/gap_between_pulses_250/imaging_1st_av_with_sd/voltage_0_108_gap_between_pulses_250_imaging_1st_av_with_sd_meansSub3_large_cross_full_null.tex}}\\
 \quad
  \subfloat[The second pulse when the imaging transducer is off,
  subtracted from the first pulse when the imaging  wave is  is in receive only mode - \unit{150}\micro\second]{
    \label{fig:exp:2nd:av:time:150:comp:control:cross:full}
...
\caption{
  The excess pressure evaluated when the imaging wave is not on.  The two images should subtract to zero.
    The phase difference between the two images has been removed in a processing step by cross-correlation.
  }
...
By comparing \figref{exp:av:time:comp:control:cross:full} and \figref{exp:av:time:comp:control:cross:long:null}
it is seen that
\nlist{
...
we re-parametrise the gamma distribution of equation \eqnref{Gamma} such that $l = \ln(x)$.
If follows that
\begin{align}
...
\caption{The log likelihood per data point for each of the three models of \figref{plot_bubble_fit_108_150}}
\end{figure}
...
The initial position and the found minima are displayed in \tabref{fit_108_150}
and \tabref{fit_108_150_fit} respectively,
...
This would imply that the estimates for the evidence given in \tabref{fit_108_150_fit} are unreliable.
...
\begin{figure}[t]%
  \centering
  \subfloat[Variation in log likelihood]{
...
\caption{Variation in parameters with iteration number for the fit of \figref{plot_bubble_fit_108_150_av:first}}
\end{figure}
...
\ctable[cap     = Parameters for \figref{plot_bubble_fit_108_150_av_2_wave_a} (RKM),
        caption = Parameters for \figref{plot_bubble_fit_108_150_av_2_wave_a},
...
\ctable[cap     = Parameters for \figref{plot_bubble_fit_108_150_av_3_wave_a} (RKM),
        caption = Parameters for \figref{plot_bubble_fit_108_150_av_3_wave_a},
        label   = table:fit_108_150:first,
        pos   = h,
        %width = 0.6\textwidth,
        left
...
An illustration is provided in \figref{plot_bubble_fit_108_150_av_2_wave_a} for two waves,
and \figref{plot_bubble_fit_108_150_av_3_wave_a} for three waves.
...
\ctable[cap     = Parameters for \figref{plot_bubble_fit_108_150_av_3_wave_filter_a} (RKM),
        caption = Parameters for \figref{plot_bubble_fit_108_150_av_3_wave_filter_a},
        label   = table:fit_108_150:first,
        pos   = h,
        %width = 0.6\textwidth,
        left
...
The filter is shown in \figref{fit:filter} and the effect of the filter is shown in \figref{plot_bubble_fit_108_150_av_3_wave_filter_a}.
...
\desc{
\item[Determine whether bubbles can be evacuated and detected]
  This objective has been convincingly achieved.
  Both the preliminary study of \chapref{rationale} and the spiked response of \figref{exp:control:av:pressure} in this chapter 
...
\item[Determine whether an evacuated bubbles can be {\em imaged by pulse-echo}]
  \Figref{exp:av:time:comp:control:cross:full} is strongly suggestive that the nucleated bubbles are responding to the high frequency imaging wave.
...
%  Can  the lifetime of the bubble be measured by using the driving-imaging wave pair, which would in turn give a second estimate of the radius?
  The excess pressure plots of \figref{exp:av:time:comp:control:cross:full} do not locate the echo of a particular bubble.
...
Secondly, \figref{exp:av:time:comp:control:cross:full} is evaluated with average traces.
Even if the returned scatter really were coming from a single bubble,
its location would be smeared in the average.
\item  [ Determine whether the acoustic Keller-Miksis predicts the  echo]
