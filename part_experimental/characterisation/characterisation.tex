...
\nlist{
  ...
  \item enables the location of the scattering bubble (it there is only one)
    to be determined.
}
...
\begin{figure}[h]%
  \centering
  \subfloat[1st pulse - 0.088 volts]{
 ...
 \quad
  \subfloat[2nd pulse - 0.088 volts]{
  ...
  \subfloat[1st pulse - 0.108 volts]{
 ...
 \quad
  \subfloat[2nd pulse - 0.108 volts]{
  ...
  \subfloat[1st pulse - 0.132 volts]{
 ...
 \quad
  \subfloat[2nd pulse - 0.132 volts]{
...
Three different pressures are shown.
  }
...
Qualitively \figref{exp:control:av:pressure:108:first}-\subref{fig:exp:control:av:pressure:132:second} 
bear a strong resemblance to the simulated bubble pulsatoins of \chapref{computations}.
...
This is because the difference between the two pulses suggests a temporal lifespan of the generated bubbles of greater than the \unit{100}\micro\second\ that exist between the pulses.
...
It is a problem because the excess pressure method requires the  response to the driving wave to 
be the same between the first and second pulse.  
...
for the pressure of \todo{pressure}.
...
As discussed in \chapref{rationale}, for each temporal offset three experiments are carried out.
...
While the phase shift makes it possible to estimate
...
\end{figure}
 ...
 \figref{1st:av:time:comp:control} compares the first pulse from the control experiment (\figref{}) with the signal from when both the driving and imaging waves are on.
...
\nlist{
  ...
  \item the phase of the two signals.
    ...
    Unlike \figref{}, however, the rest of the image, including the feature
