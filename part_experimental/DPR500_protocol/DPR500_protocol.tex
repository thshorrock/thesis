...
\begin{figure}[h]%[htp]
   ...
   \caption{
     ...
     The initiation and collection of the data is entirely computer controlled.
     A single experiment is initiated by the computer triggering an Analogic waveform generator.
     The purpose of the generator is to create a pair of trigger pulses for signal generators of the driving and imaging transducers, 
     and the oscilloscope. 
     By varying the amplitude of the trigger pulses, and the threshold at which the equipment is triggered, 
     the driving pulse can be triggered independently, enabling the high frequency wave to intercept either the first or second driving wave.
     The computer can also control the firing voltage, the gain ad the imaging mode of the imaging transducer, as well as collect the collected A-lines from the oscilloscope.
   }
...
\todo{Give a summary of the arrangement in the caption of \figref{exp:setup:electronic:final}}
