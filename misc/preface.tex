...
It was to capture the transitive and ephemeral nature of these cities.
The artist was to portray the truth of the moment, even if that meant sacrificing the truth of the visual representation.
The sociologist Michel Foucault notes in his essay, {\em What is enlightenment}, that this marked a change in how artists viewed their role.
\begin{quote}
...
Henri Poincar{\'e} prefaces {\em Science and Hypothesis} with the following 
\begin{quote}
 To the superficial observer scientific truth is unassailable,
 the logic of science is infallible;
 and if scientific men sometimes make mistakes,
...
The scientist may start with their self-evident propositions and explore where they lead.
The scientist is not external to their proposition because they must define their relation to the external world,
such as their definitions of time and space,
and state how they are to measure the world. 
...
In the numerator on the right-hand-side of \eqnref{Bayes} there are the
two terms.
...
This is not to reject the possibility of a scientific consensus, however.
...
In the denominator of \eqnref{Bayes} is  the probability of the data given the a priori view,
...
From \eqnref{BaysianComparison} we see that the degree of acceptance
