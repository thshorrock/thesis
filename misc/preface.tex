...
for ``it was recognised that [hypothesis] is as necessary to the experimenter as it is to the mathematician''.
...
the location of entities within a measurable geometry.
%They must state how they are to measure the world. 

And so here we place the charge of Jacques Lusseyran - that the seeing believe that we know the world only through our eyes.
...
By Noether's theorem one might hope that  general principles remain the same:
