...
\hl{The models of acoustic measurements are in this sense relativistic}\todo{EM analogy is not proved - revise}, and such corrections are necessary \hl{when modelling} the bubble wall velocities \hl{measured} \todo{Clarify if defined operationally of physically...}in ultrasound contrast imaging.
