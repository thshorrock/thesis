...
and have been used in this way since ... \todo{get first use of microbubbles}\cite{}.
...
The largest diameters \todo{Check this is diameter rather than radius} that may be  moved across endothelial cells (via {\em vesiculo-vacuolar transport}) are approximately \unit{150}\nano\metre\cite{Hobbs1998},
ten times smaller than the average microbubble.
Other trans-cellular transport mechanisms are still more limiting \todo{Comment on other mechanisms}.
...
grows rapidly.
The bubble then equilibrates \todo{check spelling} by dissolving.
...
Two broad approaches to acoustically generate a microbubble will be investigated:
\nlist
{
...
It was found that the vapourisation is more easily induced at higher frequencies\cite{Burns2010}\todo{Comment on dependence on surfactant - in particular zonyl...},
...
This theory is described in \chapref{AR}.
...
This is confirmed in \chapref{AR} where the full analogue is derived.
...
\Chapref{rationale} gives the scope and rationale of the experimental design at a broad level.
...
\Chapref{Motes} then presents the results of the experiments with  motes.
...
% LocalWords:  Microbubbles intracellular hifu insonated endothelial visiculo
% LocalWords:  vacuolar microbubble cavitate cavitating microbubble's Plesset
% LocalWords:  Miksis rarefactional Prosperetti Lezzi spatio gc unstabilised
% LocalWords:  Lighthill's Hestenes Perfluoropentane templated nanometers
% LocalWords:  perfluoroalkane perfluoroalkanes perfluorocarbons
% LocalWords:  perfluoropentane
