...
\listfiles
\documentclass[10pt, fleqn,final,oldfontcommands]{mythesis} %twoside,%\documentclass[10pt, astron]{article} %when have admin rights,astron
...
%part_theoretical/observables/observables,
part_theoretical/medium/medium,
%%part_theoretical/measurement-discussion/discussion,
...
\include{part_theoretical/observables/observables}
\include{part_theoretical/medium/medium}
%\include{part_theoretical/measurement-discussion/discussion}
